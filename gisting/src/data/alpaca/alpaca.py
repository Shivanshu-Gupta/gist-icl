...
class AlpacaPlus(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        AlpacaConfig(
            name="default",
            train_file="gisting/data/alpaca_plus/alpaca_plus_train.json",
            validation_seen_file="gisting/data/alpaca_plus/alpaca_plus_validation_seen.json",
            validation_unseen_file="gisting/data/alpaca_plus/alpaca_plus_validation_unseen.json",  # noqa
            validation_human_file="gisting/data/alpaca_plus/alpaca_plus_validation_human.json",  # noqa
