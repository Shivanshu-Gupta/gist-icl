...
class GistSeq2SeqTrainer(Seq2SeqTrainer):
    ...
    def evaluation_loop(
        ...
        for step, inputs in enumerate(dataloader):
            ...
            pad_across_processes = self.accelerator.pad_across_processes if hasattr(self, "accelerator") else self._pad_across_processes
            ...
            if inputs_decode is not None:
                inputs_decode = pad_across_processes(inputs_decode)
